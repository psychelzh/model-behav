...
# CPM-based prediction

Basically, we hypothesize that the more tasks we included for estimating g-factor scores, the neural prediction will be better.
...
targets::tar_load(cor_neural_samples)
targets::tar_load(cor_neural_full)
cor_neural_samples |> 
  add_row(
    num_vars = 21,
    r = as.numeric(cor_neural_full$results[, "r"])
  ) |> 
  ggplot(aes(num_vars, r)) +
